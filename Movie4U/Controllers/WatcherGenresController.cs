...
namespace Movie4U.Controllers
{
    ...
    public class WatcherGenresController : ControllerBase
    {
        ...
        [HttpGet("GetAllWatcherGenresFromPage")]
        [Authorize(Policy = "BasicUserPolicy")]
        public async Task<IActionResult> GetAllWatcherGenresFromPageAsync([FromRoute] int orderByFlagsPacked = 0, [FromRoute] int whereFlagsPacked = 0, [FromRoute] int? pageIndex = 1)
        {
